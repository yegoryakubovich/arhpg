...
from admin_web.admin_models.FaqAdmin import PriorityUpView, PriorityDownView
...
urlpatterns = [
    ...
    path(PriorityDownView.path_link, PriorityDownView.as_view(), name="priority_down"),
